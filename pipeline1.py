...
# PATHS
# -----------------------------------
DRIVE_MODEL_PATH = "/content/drive/MyDrive/asr_new/models"
LOCAL_MODEL_PATH = "/content/models"

# -----------------------------------
# COPY MODELS LOCALLY
# -----------------------------------
def copy_models_locally():
...
def load_models():
    ...
    embedding_model = SentenceTransformer(f"{LOCAL_MODEL_PATH}/minilm")

    kw_model = KeyBERT(embedding_model)

    summarizer = hf_pipeline(
        "summarization",
        model=f"{LOCAL_MODEL_PATH}/bart"
    )

    sentiment_model = hf_pipeline(
        "sentiment-analysis",
        model=f"{LOCAL_MODEL_PATH}/sentiment"
    )
