...
# Load tokenizer once (after summarizer loading)
...
def summarize_text(text):
    ...
    # Make sure max_len < input_length
    ...
    for block in BLOCK_SIZES:
        ...
        for k in K_VALUES:
            ...
            for seg in structured_segments:
                ...
                seg["embedding_model"] = "MiniLM-L6-v2"
